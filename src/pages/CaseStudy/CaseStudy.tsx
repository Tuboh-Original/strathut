...
const CaseStudy = () => {
  ...
  return (
    <Box className="max-w-[1440px] flex flex-col w-full mt-12">
      {/* Hero */}
      ...
      <Box className="py-28 2xl:py-36 px-4 md:px-12 flex flex-col gap-24 items-center">
        ...
        <Box className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {[0, 1, 2].map((ind) => (
            <Box key={ind} className="p-8 border rounded-3xl border-white30">
              <Box
        ...
        <Box className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Box className="flex flex-col gap-2">
            ...
            <p className="font-light text-lg">
              The Design stage is a meticulous process during which we apply the
              selected Concept for your digital product across all the expanded
              elements of your company - brand assets for your marketing
              department, inner pages of your website, materials for your
              business development, and more. Once the details are complete - we
              deliver a prototype of the work for a final signoff before any
              development begins.
            </p>
          </Box>
          <Box className="flex flex-col gap-2">
