...
const Contact = () => {
  return (
    <Box className="max-w-[1440px] flex flex-col w-full mt-12">
      <Box className="py-28 2xl:py-36 px-4 md:px-12 flex flex-col gap-24 items-center bg-gradientPrimary2 overflow-clip">
        <Box className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <p className="text-7xl font-medium">We'd love to hear from you</p>
          <p className="text-3xl text-textBody leading-[2.75rem]">
            Contact us regarding any concerns and inquiries.
          </p>
        </Box>
        <Box className="py-16 w-full">
