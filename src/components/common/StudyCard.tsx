...
const StudyCard: React.FC<StudyCardProps> = ({ image }) => {
  ...
  return (
    <Box className="studyCard opacity-0 p-2 sm:p-8 border rounded-xl sm:rounded-3xl border-white30 hover:p-0 hover:border-none transition-all flex flex-col gap-16 hover:gap-2 hover:mt-24 duration-700 ease-in-out relative bottom-0 h-fit">
      <Box
